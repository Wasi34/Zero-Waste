...
public class onEvntDonation extends JFrame {
    ...
    onEvntDonation(final String username) {
        ...
        lbel1 = new JLabel("Event Donation Form");
        lbel1.setBounds(30, 10, 350, 40);
        ...
        try {
            ...
            while (rs.next()) {
                cevent.add(rs.getString("event_id"));
            }
        ...
        cevent.setFont(fn2);
        cevent.setBounds(250, 73, 230, 45);
        cevent.setForeground(Color.BLACK);
        p3.add(cevent);
        ...
        btn1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                Conn con = new Conn();
                String sql = "insert into event_donation_form (username,email ,phone, location,ngo,food_type,date_of_cooking,quantity)values(?,?,?,?,?,?,?,?)";
                PreparedStatement st;
                try {
                    String eventID = cevent.getSelectedItem();
    ...
    public static void main(String[] args) {
        onEvntDonation frame = new onEvntDonation(" ");
