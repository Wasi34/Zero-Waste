            ...
            if (e.getSource() == b1) {
                ...
                if (choice == JOptionPane.YES_OPTION) {
                    ...
                    if (name.equals("")) {
                        ...
                        JOptionPane.showMessageDialog(null, "Please fill out User Name feild");

                    } else if (userid.equals("")) {
                        JOptionPane.showMessageDialog(null, "Please fill out User ID feild");
